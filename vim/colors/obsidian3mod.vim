...
execute "hi PreProc guifg="     . s:purple  . " guibg=" . s:gray_black . " gui=italic"
...
execute "hi Type guifg="        . s:earth_yellow  . " guibg=" . s:gray_black . " gui=italic"
